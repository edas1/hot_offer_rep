 ...
 */
    ...
    /** @name database information */
        ...
        $this->dbName = 'hot_offer'; // database name
        $this->dbUser = 'root'; // database user name
        $this->dbPwd = '123456'; // database user password
        $this->dbType = 'mysql';
        $this->sShopURL = 'http://otherproject.estulpinas-l.usr.nfq.lt/hot_offer'; // eShop base url, required
        $this->sSSLShopURL  = null;            // eShop SSL url, optional
        $this->sAdminSSLURL = null;            // eShop Admin SSL url, optional
        $this->sShopDir = 'C:/www/otherproject/hot_offer';
        $this->sCompileDir = 'C:/www/otherproject/hot_offer/tmp';
